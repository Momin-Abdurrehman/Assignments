...
void display_menu() {
    ...
    // Ask user if they want to display the menu again or exit
    char endChoice;
...
void computer_turn() {
    ...
    while (wickets != 10 && balls < 30) {  // Limit to 30 balls (5 overs)
...
void player_turn() {
    ...
    for (int i = 0; i < 11 && wickets < 10 && balls < 30; i++) {
    ...
    cout << "\nAll out! Total score is: " << total_score << " 🏏\n";
    if (target == 0) {
        target = total_score + 1;
